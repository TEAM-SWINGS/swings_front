...
<div
  id="actionsDropdown"
  className={`${
    showActionsDropdown ? "block" : "hidden"
...
>
  ...
  <ul className="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
    ...
    <li className="flex items-center">
      ...
      <label htmlFor="nikon" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
        Nikon (12)
      </label>
    </li>
    <li className="flex items-center">
      ...
      <label htmlFor="benq" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
        BenQ (74)
      </label>
    </li>
  </ul>
